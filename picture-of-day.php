...
<!--========================== left-sidebar ================================-->
 ...
 $date=date("F d Y");
 $que="select * from love_images where binary image_date='$date'"; 
$run=mysqli_query($con,$que);
   if(mysqli_num_rows($run) >= 1)
     {

	   $recordset = mysqli_query($con,"select * from love_images where binary image_date='$date'");
	...
	<div class="col-md-4 col-sm-8 col-xs-12" id="image-grid">
					<div class="main-content">
						<article>
							<div class="post-img">';?>
								<a href="#" target="_blank"><img class="img-responsive"   src="<?php echo $url; ?>"  alt="Post"/></a>
							</div>
